...
type APIKeyUpdateFields struct {
	Name                           bool
	Status                         bool
	OpenAIResponsesStreamEventMode bool
	Quota                          bool
	GroupID                        bool
	ExpiresAt                      bool
...
func (s *APIKeyService) Create(ctx context.Context, userID int64, req CreateAPIKeyRequest) (*APIKey, error) {
	...
	apiKey := &APIKey{
		...
		OpenAIResponsesStreamEventMode: NormalizeOpenAIResponsesStreamEventMode(req.OpenAIResponsesStreamEventMode),
		Quota:                          req.Quota,
		QuotaUsed:                      0,
...
func (s *APIKeyService) Update(ctx context.Context, id int64, userID int64, req UpdateAPIKeyRequest) (*APIKey, error) {
	...
	if req.OpenAIResponsesStreamEventMode != nil {
		...
		fields.OpenAIResponsesStreamEventMode = true
	}
