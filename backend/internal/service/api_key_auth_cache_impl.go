...
const apiKeyAuthSnapshotVersion = 20 // v20: include API Key Responses stream event mode
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	snapshot := &APIKeyAuthSnapshot{
		...
		OpenAIResponsesStreamEventMode: NormalizeOpenAIResponsesStreamEventMode(apiKey.OpenAIResponsesStreamEventMode),
		Quota:                          apiKey.Quota,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	apiKey := &APIKey{
		...
		OpenAIResponsesStreamEventMode: NormalizeOpenAIResponsesStreamEventMode(snapshot.OpenAIResponsesStreamEventMode),
