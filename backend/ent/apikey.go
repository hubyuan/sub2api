...
type APIKey struct {
	...
	// OpenAI Responses streaming event mode: strict or early_event
	OpenaiResponsesStreamEventMode string `json:"openai_responses_stream_event_mode,omitempty"`
...
func (*APIKey) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case apikey.FieldKey, apikey.FieldName, apikey.FieldStatus, apikey.FieldOpenaiResponsesStreamEventMode:
...
func (_m *APIKey) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case apikey.FieldOpenaiResponsesStreamEventMode:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field openai_responses_stream_event_mode", values[i])
			} else if value.Valid {
				_m.OpenaiResponsesStreamEventMode = value.String
			}
...
func (_m *APIKey) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("openai_responses_stream_event_mode=")
	builder.WriteString(_m.OpenaiResponsesStreamEventMode)
	builder.WriteString(", ")
